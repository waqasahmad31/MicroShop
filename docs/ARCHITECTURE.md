...
Phase 4 adds InventoryItem, InventoryService, atomic IInventoryWriter/EfInventoryWriter and
IInventoryReader/DapperInventoryReader. OnHand/Reserved live only in inventory_db; Available is derived.
