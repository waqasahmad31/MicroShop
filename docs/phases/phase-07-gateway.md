...
YARP route groups for auth, catalog, inventory and orders; clear path forwarding.

## Definition of Done
Catalog/Inventory/Ordering route tests pass; route configuration ready for Identity; no business logic in Gateway; unknown routes and service failures observable.
