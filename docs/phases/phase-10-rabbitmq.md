...
Direct RabbitMQ.Client, minimal IEventBus, sample event, durable exchange/queues, routing, confirms, manual ACK, bounded retry and dead-letter behavior.

## Definition of Done
Publish/consume demonstrated including unavailable/unroutable broker and bad-message paths; no infinite requeue; documentation explains topology and delivery semantics.
