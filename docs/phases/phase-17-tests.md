...
Meaningful domain, use-case, API, role/ownership, stock race, event and outage/recovery tests; deterministic fixtures.

## Definition of Done
dotnet test passes; infrastructure prerequisites explicit; create/update product, adjustment, checkout, insufficient stock, event duplicate and auth scenarios covered; no arbitrary coverage target.
