...
Consume confirmation/rejection into structured notification logs with event/order/correlation IDs.

## Definition of Done
Both outcomes observable through independent queues; failures bounded; best-effort log persistence limitation explicit; no external email.
