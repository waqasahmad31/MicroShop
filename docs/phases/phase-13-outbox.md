...
Ordering transactional Outbox and dispatcher, then Inventory Outbox for outcome/release events; publish confirms before processed marking.

## Definition of Done
Broker outage and restart recover committed pending events; order/stock and event writes are atomic locally; duplicate-delivery window demonstrated; no distributed transactions.
