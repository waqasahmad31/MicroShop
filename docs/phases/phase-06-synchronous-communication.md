...
Typed Catalog/Inventory clients with IHttpClientFactory, server-side prices, availability check and Pending order creation.

## Definition of Done
End-to-end HTTP flow and missing products/insufficient stock/timeouts/cancellation verified; documented check-versus-reservation limitation; no RabbitMQ.
