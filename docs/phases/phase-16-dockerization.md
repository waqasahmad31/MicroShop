...
Dockerfiles for seven hosts, application Compose services and DNS/configuration, Web-hosted client assets, migrations/startup procedure.

## Definition of Done
Configured fresh checkout runs via docker compose up --build; full order/login flow, health, persistence and restart verified; localhost-only development exposure documented.
