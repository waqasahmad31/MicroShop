...
InventoryItem, on-hand/reserved/available invariants, stock adjustments, EF writes, Dapper reads, migrations and deterministic seeds.

## Definition of Done
Adjustments and reads work; negative/invalid values rejected; concurrent adjustments tested; no access to other databases.
