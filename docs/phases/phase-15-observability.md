...
Structured logs and trace context, ASP.NET/HTTP/runtime telemetry, explicit RabbitMQ propagation, OTLP configuration, /health and live/ready checks.

## Definition of Done
HTTP and async traces correlated; useful metrics visible; dependency failure distinguishes readiness from liveness; no secrets logged; viewer choice documented.
