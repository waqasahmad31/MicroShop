...
Products/categories, validation, EF DbContext/configurations/migrations and writes, Dapper pagination/search/details, OpenAPI UI and development seed data.

## Definition of Done
Create/update/delete/query and invalid-input tests pass; migrations apply to catalog_db only; SQL parameterized; endpoint docs accurate.
