...
Typed frontend clients; layout/navigation; product/category management, browsing, inventory, dashboard, orders, my-orders, cart and checkout.

## Definition of Done
UI runs through Gateway; forms/loading/error/empty states work; no raw HTTP in Razor; no service implementation references; Pending checkout limitation visible.
